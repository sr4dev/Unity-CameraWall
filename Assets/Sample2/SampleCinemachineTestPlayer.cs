...
namespace PerspectiveCameraWall.Sample2
{
    ...
    public class SampleCinemachineTestPlayer : MonoBehaviour
    {
        [Range(0.1f, 10f)]
        ...
        private void Start()
        {
            SampleCinemachineManager.Instance.target = gameObject;
        }
        ...
        private void FixedUpdate()
        {
            ...
            Vector3 camAngles = SampleCinemachineManager.Instance.mainCamera.transform.eulerAngles;
